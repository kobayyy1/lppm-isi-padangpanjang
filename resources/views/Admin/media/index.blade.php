...
@section('content')
    <div x-data="{ sidebarOpen: false }" class="flex min-h-screen bg-gray-100 font-['Roboto']"
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-x-hidden">
            ...
            <!-- Main Scrollable Wrapper Inside Panel -->
            <main class="flex-1 p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 overflow-y-auto">
                ...
                <!-- Card Content Core Block Wrapper -->
                <div class="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div
                        ...
                        <div class="text-left">
                            <h3 class="text-base sm:text-lg font-black text-[#0f2440] uppercase tracking-tight">Daftar
                                Galeri Media</h3>
                        ...
                        <a href="{{ route('admin.media.create') }}"
                            class="bg-[#0f2440] text-white hover:bg-slate-800 font-bold text-xs px-5 py-3 rounded-xl uppercase tracking-wider transition-all select-none text-center w-full sm:w-auto shadow-md">
                            Tambah Media Baru
                        </a>
                    </div>

                    <!-- Responsive Scroll Table Element -->
                        ...
                        <table class="w-full text-left border-collapse min-w-[700px]">
                            <thead>
                                <tr
                                    ...
                                    <th class="py-4 px-4 sm:px-6 w-64">Judul Media</th>
                                    <th class="py-4 px-4 sm:px-6">Deskripsi Singkat</th>
                                ...
                                @forelse($medias as $media)
                                    <tr class="hover:bg-gray-50/80 transition-colors">
                                        <td class="py-4 px-4 sm:px-6">
                                            <div
                                                class="w-16 h-12 rounded-lg overflow-hidden bg-slate-100 border border-gray-200 shadow-sm flex items-center justify-center flex-shrink-0">
                                                <img src="{{ $media->image ? asset('storage/' . $media->image) : asset('images/berita1.png') }}"
                                                    class="w-full h-full object-cover shadow-inner">
                                            </div>
                                        </td>
                                        <td class="py-4 px-4 sm:px-6 font-bold text-gray-800 max-w-xs truncate">
                                            {{ $media->title }}
                                        </td>
                                        <td
                                            class="py-4 px-4 sm:px-6 max-w-xs md:max-w-sm truncate font-light text-gray-500">
