            ...
            <main class="flex-1 p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 overflow-y-auto">
                ...
                <div class="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div
                        ...
                        <div class="text-left">
                            <h3 class="text-base sm:text-lg font-black text-[#0f2440] uppercase tracking-tight">Daftar Papan
                                Informasi</h3>
                    ...
                    <!-- Responsive Scroll Table Grid Area -->
                        ...
                        <table class="w-full text-left border-collapse min-w-[700px]">
                            <thead>
                                <tr
                                    ...
                                    <th class="py-4 px-4 sm:px-6 w-64">Judul Informasi</th>
